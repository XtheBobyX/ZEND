...
function Login() {
  ...
  const handleInputs = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setUsuario((data) => ({ ...data, [name]: value }));
  };
  ...
  return (
    <div className="w-[90%] flex mx-auto mt-16">
      ...
      <div className="w-full lg:w-3/5 bg-[#1B1B1B] border-4 border-purple-700 px-4 shadow-2xl shadow-purple-500">
        ...
        >
          ...
          <input
            type="submit"
            value="Entrar"
            className="w-72 md:w-96 md:py-5 my-8 py-3 rounded-3xl  text-xl bg-purple-700 hover:bg-purple-600 cursor-pointer"
          />
          <p className="mb-20">
